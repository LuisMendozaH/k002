...
<div class="_li">
    ...
    <?php $this->view->render("appbar/setup_appbar.html", $this->client_data); ?>
    <div class="" style="position:relative;padding-top:48px">
        <div class="Cw Ws"></div>
        <div class="Cw We">
            <?php $this->view->render("section/gettingstarted.html", $this->client_data) ?>
            <?php $this->view->render("footer/default.html", $this->client_data) ?>
        </div>
        <div class="Cw Ws"></div>
    </div>
</div>
